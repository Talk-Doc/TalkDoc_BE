...
public enum ErrorCode {
    ...
    DRAFT_NOT_FOUND(HttpStatus.NOT_FOUND, "답변 초안을 찾을 수 없습니다."),
    RECOGNITION_NOT_FOUND(HttpStatus.NOT_FOUND, "인식 결과를 찾을 수 없습니다."),
    NO_PENDING_QUESTION(HttpStatus.CONFLICT, "현재 답변 대기 중인 질문이 없습니다."),
    QUESTION_ALREADY_ANSWERED(HttpStatus.CONFLICT, "확정 답변이 있는 질문은 수정할 수 없습니다."),
    VERSION_CONFLICT(HttpStatus.CONFLICT, "버전이 일치하지 않습니다."),
    DRAFT_INVALIDATED(HttpStatus.CONFLICT, "무효화된 답변 초안입니다."),
